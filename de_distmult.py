...
class DE_DistMult(torch.nn.Module):
    ...
    def __init__(self, dataset, params):
        ...
        self.ent_embs = nn.Embedding(dataset.numEnt(), params.s_emb_dim).to(self.params.device)
        self.rel_embs = nn.Embedding(dataset.numRel(), params.s_emb_dim + params.t_emb_dim).to(self.params.device)
    ...
    def create_time_embedds(self):
        ...
        self.m_freq = nn.Embedding(self.dataset.numEnt(), self.params.t_emb_dim).to(self.params.device)
        self.d_freq = nn.Embedding(self.dataset.numEnt(), self.params.t_emb_dim).to(self.params.device)
        self.y_freq = nn.Embedding(self.dataset.numEnt(), self.params.t_emb_dim).to(self.params.device)
        ...
        self.m_phi = nn.Embedding(self.dataset.numEnt(), self.params.t_emb_dim).to(self.params.device)
        self.d_phi = nn.Embedding(self.dataset.numEnt(), self.params.t_emb_dim).to(self.params.device)
        self.y_phi = nn.Embedding(self.dataset.numEnt(), self.params.t_emb_dim).to(self.params.device)
        ...
        self.m_amp = nn.Embedding(self.dataset.numEnt(), self.params.t_emb_dim).to(self.params.device)
        self.d_amp = nn.Embedding(self.dataset.numEnt(), self.params.t_emb_dim).to(self.params.device)
        self.y_amp = nn.Embedding(self.dataset.numEnt(), self.params.t_emb_dim).to(self.params.device)
